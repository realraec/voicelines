    ...
    for (int i = 0; i < audios.size(); i++) {
      ...
      try {
        ...
        /*if (!childSource.toLowerCase().contains("_select")
          ...
          String siblingJointNames = audioKindLiTd.previousElementSibling().toString();
          //System.out.println("\t\t\t"+audioKindLiTd.previousElementSibling().text().trim());

          if (childSource.toLowerCase().contains("_tower")) {
            audioName = siblingJointNames.substring(siblingJointNames.indexOf(">") + 1, siblingJointNames.indexOf("<br>"));
            ...
            audioName = siblingJointNames.substring(siblingJointNames.lastIndexOf("<br>") + 4,
                siblingJointNames.lastIndexOf("<"));
          ...
          // Last letter
          String VGSLetter = audioKindLiTd.previousElementSibling().previousElementSibling().text().trim();



          // Whole line with section name and beginning VGS code
          /*System.out.println(audios.get(i).parent().parent().parent().parent().parent()
              .previousElementSibling().toString());*/
          //sectionElement = audioKindLiTd.parent().parent().parent().previousElementSibling();
          ...
          // 1st kind (same line)
          //System.out.println(audioKindLiTd.text());
          ...
          //System.out.println(sectionElement.toString());
          //sectionName = sectionElement.child(0).text();


          //System.out.println("\t\t\t"+sectionElement.text());
          //System.out.println("\t\t\t\t\t\t"+sectionElement.child(0).text());
          ...
          if (audioName.contains("▶️")) {
            ...
            /*System.out.println("0" + audios.get(i).parent().parent().id());
            System.out.println("1\t" + audios.get(i).parent().parent().className());
            System.out.println("2\t\t" + audios.get(i).parent().parent().parent().previousElementSibling().tagName());
            System.out.println("3\t\t\t" + audios.get(i).parent().parent().parent().previousElementSibling().normalName());
            System.out.println("4\t\t\t\t" + audios.get(i).parent().parent().val());*/
          ...
          if (!sectionElement.normalName().equals("p")) {
            sectionName = sectionElement.child(0).text();
          } else {
        ...
        // SECTIONS
        if (sectionNameComparison2.equals("") || !sectionName.equals(sectionNameComparison2)) {
          sectionNameComparison2 = sectionName;
        /*System.out.println(wholeText);
        ...
        System.out.println("---------------");*/
          ...
          // SUBSECTIONS
          // 1st kind (same line)
          System.out.println("\t\t\t\t\t\t"+sectionElement.normalName());
